          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <a
                  href="https://github.com/rubesh007"
                  className="text-muted-foreground hover:text-neon-cyan hover:text-glow-cyan transition-colors"
                >
                  <Github size={20} />
                </a>
              </TooltipTrigger>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <a
                  href="https://www.instagram.com/_.mr.ruby._?igsh=MWgwemZoNGN6aGRjaQ=="
                  className="text-muted-foreground hover:text-neon-cyan hover:text-glow-cyan transition-colors"
                >
                  <Instagram size={20} />
                </a>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <a
                  href="https://www.linkedin.com/in/rubesh-kumar-s-674804384"
                  className="text-muted-foreground hover:text-neon-cyan hover:text-glow-cyan transition-colors"
                >
                  <Linkedin size={20} />
                </a>
